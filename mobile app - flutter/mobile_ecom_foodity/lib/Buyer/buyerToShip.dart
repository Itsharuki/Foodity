...
class BuyerToShip extends StatefulWidget {
  const BuyerToShip({super.key});

  @override
  State<BuyerToShip> createState() => _BuyerToShipState();
}

class _BuyerToShipState extends State<BuyerToShip> {
...
Future<void> getOrders({int page = 1}) async{
  ...
  try{
    ...
    '$globalurl/getOrdersToShip?page=$page');
