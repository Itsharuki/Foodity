...
class BuyerCompleted extends StatefulWidget {
  const BuyerCompleted({super.key});

  @override
  State<BuyerCompleted> createState() => _BuyerCompletedState();
}

class _BuyerCompletedState extends State<BuyerCompleted> {
...
Future<void> getOrders({int page = 1}) async{
  ...
  try{
    ...
    '$globalurl/getOrdersCompleted?page=$page');
